...
import { getBrands, addBrand } from '../../../store/actions/products_actions';
...
// We need 'mapStateToProps' to INJECT the 'products' data(coming from Redux) into the 'props' of this Component
